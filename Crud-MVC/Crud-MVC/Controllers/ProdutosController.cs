...
namespace Crud_MVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["Categoria"] = new SelectList(_context.Categorias, "Id", "Descricao");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Quantidade,CategoriaId")] Produto produto)
        {
            ...
            ViewData["Categoria"] = new SelectList(_context.Categorias, "Id", "Descricao", produto.CategoriaId);
            return View(produto);
        }
